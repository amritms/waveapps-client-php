...
class WaveappsTest extends TestCase
{
    const WAVEAPPS_URI = 'https://gql.waveapps.com/graphql/public';
    const WAVEAPPS_TOKEN = 'waveappsDummyAccessToken';
    const WAVEAPPS_BUSINESS_ID = 'waveappsDummyBusinessID';
    ...
    public function it_returns_logged_in_user()
    {
        ...
        $waveAppClient = new WaveApps($client, self::WAVEAPPS_URI, self::WAVEAPPS_TOKEN, self::WAVEAPPS_BUSINESS_ID);
    ...
    public function it_returns_business_accounts()
    {
        ...
        $waveAppClient = new WaveApps($client, self::WAVEAPPS_URI, self::WAVEAPPS_TOKEN, self::WAVEAPPS_BUSINESS_ID);
        $businessAccounts = $waveAppClient->business(['business_id' => 'unique_business_id_1']);
    ...
    public function it_returns_business_accounts_filtered()
    {
        ...
        $waveAppClient = new WaveApps($client, self::WAVEAPPS_URI, self::WAVEAPPS_TOKEN, self::WAVEAPPS_BUSINESS_ID);
        $businessAccount = $waveAppClient->business(['business_id' => 'unique_business_id_1', 'account_id' => 'unique_account_id_1']);
    ...
    public function it_returns_business_customers()
    {
        ...
        $waveAppClient = new WaveApps($client, self::WAVEAPPS_URI, self::WAVEAPPS_TOKEN, self::WAVEAPPS_BUSINESS_ID);
        $businessCustomers = $waveAppClient->customer(['business_id' => 'unique_business_id_1']);
    ...
    public function it_returns_business_customer_filtered()
    {
        ...
        $waveAppClient = new WaveApps($client, self::WAVEAPPS_URI, self::WAVEAPPS_TOKEN, self::WAVEAPPS_BUSINESS_ID);
        $businessCustomer = $waveAppClient->customers(['business_id' => 'unique_business_id_1', 'customer_id' => 'unique_customer_id_1']);
    ...
    public function it_returns_business_invoices()
    {
        ...
        $waveAppClient = new WaveApps($client, self::WAVEAPPS_URI, self::WAVEAPPS_TOKEN, self::WAVEAPPS_BUSINESS_ID);
        $businessInvoices = $waveAppClient->invoices(['business_id' => 'unique_business_id_1']);
    ...
    public function it_returns_business_invoice_filtered()
    {
        ...
        $waveAppClient = new WaveApps($client, self::WAVEAPPS_URI, self::WAVEAPPS_TOKEN, self::WAVEAPPS_BUSINESS_ID);
        $businessInvoice = $waveAppClient->invoices(['business_id' => 'unique_business_id_1', 'invoice_id' => 'unique_invoice_id_1']);
    ...
    public function it_returns_business_products()
    {
        ...
        $waveAppClient = new WaveApps($client, self::WAVEAPPS_URI, self::WAVEAPPS_TOKEN, self::WAVEAPPS_BUSINESS_ID);
        $businessProducts = $waveAppClient->products(['business_id' => 'unique_business_id_1']);
    ...
    public function it_returns_business_product_filtered()
    {
        ...
        $waveAppClient = new WaveApps($client, self::WAVEAPPS_URI, self::WAVEAPPS_TOKEN, self::WAVEAPPS_BUSINESS_ID);
        $businessProduct = $waveAppClient->products(['business_id' => 'unique_business_id_1', 'product_id' => 'unique_product_id_1']);
    ...
    public function it_returns_business_with_all_related_entities()
    {
        ...
        $waveAppClient = new WaveApps($client, self::WAVEAPPS_URI, self::WAVEAPPS_TOKEN, self::WAVEAPPS_BUSINESS_ID);
        $business = $waveAppClient->business(['business_id' => 'unique_business_id']);
